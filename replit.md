...
- **Current commercial mode**: CommercePulse is temporarily free. Billing, checkout, paid-access gates, and provider webhooks are removed from the application while product validation continues. Legacy billing columns remain in the database only for non-destructive schema compatibility.
