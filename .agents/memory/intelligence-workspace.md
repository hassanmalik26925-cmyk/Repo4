...
**How to apply:** Reuse existing persisted order, product, customer, campaign, trend, integration, and insight responses first. Copilot alert rules are account-backed settings; show explicit empty states when a connector or metric source is unavailable, and do not fabricate traffic or ad data.