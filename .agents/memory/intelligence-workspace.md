...
**How to apply:** Reuse existing persisted order, product, customer, campaign, trend, integration, and insight responses first. Clearly label local/browser-only alert rules and show explicit empty states when a connector or metric source is unavailable; do not fabricate traffic or ad data.