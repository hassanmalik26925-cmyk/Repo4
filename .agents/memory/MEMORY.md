...
- [Demo vs real users](demo-vs-real-users.md) — usersTable.isDemo gates integration disconnect no-op for demo account; branch new state-changing endpoints the same way.
